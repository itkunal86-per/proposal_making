          ...
          <div className="prose prose-invert mt-12 max-w-none space-y-8">
            <section>
              ...
              <p className="mt-4 text-muted-foreground">
                By accessing and using this website and service, you accept and agree to be
            ...
            <section>
              ...
              <p className="mt-4 text-muted-foreground">
                ...
                the laws of the jurisdiction where Proposal AI operates, and you irrevocably
                submit to the exclusive jurisdiction of the courts located in that location.
              </p>
            </section>

            <section>
              <h2 className="text-2xl font-semibold">9. User Accounts</h2>
              <p className="mt-4 text-muted-foreground">
                When you create an account with us, you are responsible for providing accurate
                information and for maintaining the confidentiality of your account login
                credentials. You agree to accept responsibility for all activities that occur
                under your account. You must notify us immediately of any unauthorized use of
            ...
            <section>
              ...
              <ul className="mt-3 list-inside list-disc space-y-2 text-muted-foreground">
                <li>
                  By email: <span className="text-foreground">legal@proposalai.com</span>
                </li>
                <li>
