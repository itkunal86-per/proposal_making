                    ...
                    {section.layout === "three-column" && [(section as any).columnContents?.[0], (section as any).columnContents?.[1], (section as any).columnContents?.[2]].map((content, colIndex) => (
                      <div
                        ...
                        style={{
                          ...
                          backgroundSize: (section as any).columnStyles?.[colIndex]?.backgroundSize || (section as any).contentStyles?.backgroundSize || "cover",
                          backgroundPosition: "center",
                          backgroundRepeat: "no-repeat",
                          paddingTop: `${(section as any).columnStyles?.[colIndex]?.paddingTop || (section as any).contentStyles?.paddingTop || 0}px`,
                          paddingRight: `${(section as any).columnStyles?.[colIndex]?.paddingRight || (section as any).contentStyles?.paddingRight || 0}px`,
                          paddingBottom: `${(section as any).columnStyles?.[colIndex]?.paddingBottom || (section as any).contentStyles?.paddingBottom || 0}px`,
                          paddingLeft: `${(section as any).columnStyles?.[colIndex]?.paddingLeft || (section as any).contentStyles?.paddingLeft || 0}px`,
                          marginTop: `${(section as any).columnStyles?.[colIndex]?.marginTop || (section as any).contentStyles?.marginTop || 0}px`,
                          marginRight: `${(section as any).columnStyles?.[colIndex]?.marginRight || (section as any).contentStyles?.marginRight || 0}px`,
                          marginBottom: `${(section as any).columnStyles?.[colIndex]?.marginBottom || (section as any).contentStyles?.marginBottom || 0}px`,
                          marginLeft: `${(section as any).columnStyles?.[colIndex]?.marginLeft || (section as any).contentStyles?.marginLeft || 0}px`,
                          borderRadius: (section as any).columnStyles?.[colIndex]?.borderRadius || (section as any).contentStyles?.borderRadius ? `${(section as any).columnStyles?.[colIndex]?.borderRadius || (section as any).contentStyles?.borderRadius}px` : undefined,
